import conv2dtfWGSL from '../../shaders/restore/GANUUL/conv2dtf.wgsl';
import conv2dtf1WGSL from '../../shaders/restore/GANUUL/conv2dtf1.wgsl';
import conv2d1tfWGSL from '../../shaders/restore/GANUUL/conv2d1tf.wgsl';
import conv2d1tf1WGSL from '../../shaders/restore/GANUUL/conv2d1tf1.wgsl';
import conv2d1tf2WGSL from '../../shaders/restore/GANUUL/conv2d1tf2.wgsl';
import conv2d2tfWGSL from '../../shaders/restore/GANUUL/conv2d2tf.wgsl';
import conv2d2tf1WGSL from '../../shaders/restore/GANUUL/conv2d2tf1.wgsl';
import conv2d3tfWGSL from '../../shaders/restore/GANUUL/conv2d3tf.wgsl';
import conv2d3tf1WGSL from '../../shaders/restore/GANUUL/conv2d3tf1.wgsl';
import conv2d3tf2WGSL from '../../shaders/restore/GANUUL/conv2d3tf2.wgsl';
import conv2d4tfWGSL from '../../shaders/restore/GANUUL/conv2d4tf.wgsl';
import conv2d4tf1WGSL from '../../shaders/restore/GANUUL/conv2d4tf1.wgsl';
import conv2d5tfWGSL from '../../shaders/restore/GANUUL/conv2d5tf.wgsl';
import conv2d5tf1WGSL from '../../shaders/restore/GANUUL/conv2d5tf1.wgsl';
import conv2d5tf2WGSL from '../../shaders/restore/GANUUL/conv2d5tf2.wgsl';
import conv2d6tfWGSL from '../../shaders/restore/GANUUL/conv2d6tf.wgsl';
import conv2d6tf1WGSL from '../../shaders/restore/GANUUL/conv2d6tf1.wgsl';
import output from '../../shaders/restore/GANUUL/output.wgsl';
